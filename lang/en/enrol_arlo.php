...
$string['enrolmentinstanceadded'] = 'Enrolment instance added';
$string['enrolmentinstancedeleted'] = 'Enrolment instance deleted';
...
$string['sessioncreated'] = 'Session from Arlo created in Moodle';
$string['sessionstask'] = 'Create and update Arlo Event Sessions for enabled enrolment instances';
$string['sessionupdated'] = 'Session from Arlo updated in Moodle';
