...
/**
 * A existing Arlo session updated event class.
 *
 * @package     enrol_arlo
...
/**
 * The enrol_arlo field updated session event class.
 *
 * @property-read array $other {
 *      Extra information about session.
 *
...
class session_updated extends \core\event\base {
    ...
    public static function get_name() {
        return get_string('sessionupdated', 'enrol_arlo');
    }
    ...
    public function get_description() {
        return "Updated Arlo Session Event record '" . $this->other['id'] . "'.";
    }
    ...
    protected function validate_data() {
        ...
        if (!isset($this->other['sourceeventid'])) {
            throw new \coding_exception("The sourceeventid value must be set in other.");
        }
        if (!isset($this->other['sourceeventguid'])) {
            throw new \coding_exception("The sourceeventguid value must be set in other.");
        }
        if (!isset($this->other['name'])) {
            throw new \coding_exception("The name value must be set in other.");
        }
        if (!isset($this->other['startdatetime'])) {
            throw new \coding_exception("The startdatetime value must be set in other.");
        }
        if (!isset($this->other['finishdatetime'])) {
            throw new \coding_exception("The finishdatetime value must be set in other.");
        }        
    }
