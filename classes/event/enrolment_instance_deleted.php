 ...
 * @copyright  2022 Palmeira Group Ltd {@link http://www.palmeiragroup.co.uk}
 * @license    http://www.gnu.org/copyleft/gpl.html GNU GPL v3 or later
 */
class enrolment_instance_deleted extends \core\event\base {
    ...
    public static function get_name() {
        return get_string('enrolmentinstancedeleted', 'enrol_arlo');
    }
    ...
    public function get_description() {
        return "Arlo enrolment instance deleted '" . $this->other['id'] . "'.";
    }
