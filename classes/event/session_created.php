...
/**
 * A new Arlo session created event.
 *
 * @package     enrol_arlo
...
/**
 * A new Arlo session created event class.
 *
...
class session_created extends \core\event\base {
    ...
    public static function get_name() {
        return get_string('sessioncreated', 'enrol_arlo');
    }
    ...
    public function get_description() {
        return "Created Arlo Event Session record '" . $this->other['id'] . "'.";
    }
